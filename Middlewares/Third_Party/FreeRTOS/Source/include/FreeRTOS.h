...
extern void BA_ConfigureTimerForDebugTick();
extern uint32_t BA_GetDebugTickCount();
#define portCONFIGURE_TIMER_FOR_RUN_TIME_STATS() BA_ConfigureTimerForDebugTick()
#define portGET_RUN_TIME_COUNTER_VALUE() BA_GetDebugTickCount()
